...
GAME_STAT = True
input_file = RANK_DIR / "rank.txt"
excel_file = '14pt'

if GAME_STAT:
    workbook_path = RANK_DIR / f'game_{excel_file}.xlsx'
else:
    workbook_path = RANK_DIR / f'{excel_file}.xlsx'
...
print(f"Data has been updated with momentum in {workbook_path}")
